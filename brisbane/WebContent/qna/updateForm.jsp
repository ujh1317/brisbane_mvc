...
<script src="writeForm.js" type="text/javascript"></script>
</head>
<body>
...
<c:if test="${empty sessionScope.memId}">
	<table align="center">
		...
		<tr>
			<td align="center">
				<input type="button" value="로그인 화면" onClick="location='${ctxpath}/member/main.do'">
...
<c:if test="${!empty sessionScope.memId and sessionScope.memId eq dto.writer}">
<form name="writeForm" id="writeForm" method="post" action="${ctxpath}/qna/updatePro.do?pageNum=${pageNum}">
	...
	<table align="center">
		...
		<tr>
			<td colspan="2">
					...
					<input type="text" name="subject" id="subject" size="78" value="${dto.subject}">
					<input type="hidden" name="num" id="num" value="${num}">

				<select name="category" id="category">
				
					<option selected value="${dto.category}">
						${dto.category}
					</option>
		...
		<tr>
			<td colspan="2">
			  	...
			  	<textarea id="content" name="content" rows="10" cols="90">${dto.content}</textarea>						  						
			  	<br><br>
		  	</td>
	  	</tr>
		<tr>
