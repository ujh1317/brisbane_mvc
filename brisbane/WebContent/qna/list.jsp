...
<table width="700" align="center">
	...
	<tr>
		<td align="left">
			<select id="list_category" name="list_category" onChange="var value=list_category.options[list_category.selectedIndex].value;location='${ctxpath}/qna/list.do?list_category='+value;">
		...
		<td align="right">
			<button><a href="${ctxpath}/qna/writeForm.do">글쓰기</a></button>
					...
					<td>
						...
						<c:if test="${dto.bounds==1}">
							...
							<c:if test="${sessionScope.memId eq dto.writer or sessionScope.memId eq 'admin'}">
								...
								<a href="${ctxpath}/qna/content.do?num=${dto.num}&pageNum=${pageNum}">
									${dto.subject}
								</a>
							</c:if>
	...
	<tr><td>
		...
		<c:if test="${startPage>10}">
			<a href="${ctxpath}/qna/list.do?pageNum=${startPage-10}">
			[이전 블럭]
			</a>
		</c:if>
