...
<form name="writeForm" id="writeForm" method="post" action="${ctxpath}/qna/writePro.do">
	...
	<table align="center">
		...
		<tr>
			<td colspan="2">
				...
				<c:if test="${num!=0}">
					<input type="text" name="subject" id="subject" size="78" value="[답글]${dto.subject}">
				</c:if>
