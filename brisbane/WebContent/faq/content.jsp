...
<body>
  ...
  <table width="700" align="center">
    ...
    <tr>
      ...
      <td bgcolor="#c8e5f9">조횟수</td>
      <td bgcolor="#e1f1fc">${dto.count}</td>
    </tr>
    
    <tr>
      <td bgcolor="#c8e5f9">작성자</td>
      <td bgcolor="#e1f1fc">${dto.name}</td>
    ...
    <tr>
      <td colspan="4" align="center">
       ...
       <input type="button" value="답글쓰기" onClick="location='${ctxpath}/faq/writeForm.do?num=${num}&pageNum=${pageNum}&ref=${ref}&re_step=${re_step}&re_level=${re_level}'">
       <input type="button" value="리스트" onClick="location='${ctxpath}/faq/list.do?pageNum=${pageNum}'">
      </td>
    </tr>
